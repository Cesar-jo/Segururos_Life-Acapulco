...
$cuentas = get_cuentas_by_pagar(cur_user()['id']);

$data =
[
  'title'      => 'Cuentas por pagar',
  'active'     => 'cuentas_porpagar',
  'cuentas'      => (isset($cuentas[0]) ? $cuentas[0] : NULL),
  'pagination' => (isset($cuentas[1]) ? $cuentas[1] : NULL)
];

// Renderizado de la vista
//esto hace que carge todos los juegos que tenga un usuario
if (cur_user()['rol'] == 1) {
  render_view('cuentas_porpagar' , $data);
}else {
