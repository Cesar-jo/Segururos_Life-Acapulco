...
<head>
  ...
  <!-- Icono del sistema -->
  <link rel="icon" type="image/png" href="assets/images/idhasa_logo.png" >

  <!-- Bootstrap 4 -->
  <link rel="stylesheet" href="<?php echo CSS.'bootstrap.min.css' ?>">
  <!-- boostrap-sm admin -->
  <link rel="stylesheet" href="<?php echo CSS.'sb-admin-2.css' ?>">
  <link rel="stylesheet" href="<?php echo CSS.'sb-admin-2.min.css' ?>">
