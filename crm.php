...
$clientes = get_clientes_by_estatus(cur_user()['id']);
...
//Si es usuario admin que le muestre la ventana si no que lo redireccione a otra paguina
if (cur_user()['rol'] == 1) {
  render_view('crm' , $data);
}else {
