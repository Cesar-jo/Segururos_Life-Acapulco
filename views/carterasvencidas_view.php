...
<tr>
 <th scope="col" style="font-size: 12px;">ID</th>
   ...
   <th scope="col" style="font-size: 12px;">Facturación</th>
   <th scope="col" style="font-size: 12px;">Contratación</th>
...
<?php foreach ($data['clientes'] as $c): ?>
     ...
     <tr>
         ...
         <th><a class="btn btn-primary rounded shadow" style="font-size: 11px;" href="<?php echo 'factura.php?id='.$c['id']; ?>" title="Factura"> <i class="fas fa-file-contract"></i> Factura</a></th>
      ...
      <div class="text-center py-5">
        ...
        <p class="mt-3 text-muted">No tienes clientes morosos, intenta agregando el primero</p>
