...
<tr>
   ...
   <th scope="col" style="font-size: 12px;">Metodo de pago</th>
...
AND id_usuario = '$id_usuario' ")or die($mysql -> error); 
     ...
     <?php  while  ($lista= mysqli_fetch_array($datos)){ ?>
      ...
      <tr>
         ...
         <th><p class="mb-0" style="font-size: 11px;"><span><?php echo $lista['telefono']; ?></span></p></th>
         <th><p class="mb-0" style="font-size: 11px;"><span><?php echo $lista['fecha']; ?></span></p></th>
         <th><p class="mb-0" style="font-size: 11px;"><span><?php echo $lista['venc_factura']; ?></span></p></th>
         <th><p class="mb-0" style="font-size: 11px;"><span><?php echo $lista['venc_contrato']; ?></span></p></th>
  ...
  <th><a class="btn btn-success rounded shadow" style="font-size: 13px;" href="<?php echo 'pagos.php?id='.$lista['id']; ?>" title="Pagos"><i class="fas fa-handshake"></i> Pagos</a></th>


         <th><a class="btn btn-primary rounded shadow" style="font-size: 13px;" href="<?php echo 'factura.php?id='.$lista['id']; ?>" title="Factura"> <i class="fas fa-file-contract"></i> Factura</a></th>
