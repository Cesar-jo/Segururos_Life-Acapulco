        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-3">
          <div class="card">
            ...
            <div class="card-body p-2">
              ...
              <button class="btn btn-sm btn-success float-right do_view_game rounded shadow" data-id="<?php echo $r['id']; ?>" data-toggle="tooltip" title="Me interesa"><i class="fas fa-eye"></i></button>
