...
<tr>
 <th scope="col" style="font-size: 12px;">ID</th>
   ...
   <th scope="col" style="font-size: 12px;">CURP</th>
   <th scope="col" style="font-size: 12px;">RFC</th>
   <th scope="col" style="font-size: 12px;">Dirección</th>
...
<?php foreach ($data['clientes'] as $c): ?>
     ...
     <tr>
         ...
         <th><p class="mb-0" style="font-size: 11px;"><span><?php echo $c['curp']; ?></span></p></th>
         <th><p class="mb-0" style="font-size: 11px;"><span><?php echo $c['rfc']; ?></span></p></th>
         <th><p class="mb-0" style="font-size: 11px;"><span><?php echo $c['direccion']; ?></span></p></th>
         ...
         <th><a class="btn btn-sm btn-outline-success rounded shadow" style="font-size: 12px;" href="<?php echo 'https://wa.me/'.$c['telefono']; ?><?php echo '?text=%20Hola%20'.$c['nombre']; ?><?php echo '%20Su%20contrato%20vence%20el%20'.$c['venc_contrato']; ?><?php echo '%20y%20su%20factura%20el%20'.$c['venc_factura']; ?>" title="Enviar"><i class="fab fa-whatsapp"></i> Enviar</a></th>
      ...
      <div class="text-center py-5">
        ...
        <p class="mt-3 text-muted">No tienes clientes registrados, intenta agregando el primero</p>
