...
<div class="container" style="padding: 200px 0px;">
  <div class="row">
    <div class="offset-xl-3 col-xl-6">
      <div class="card shadow rounded shadow">
        <div class="card-body">
          <h2 class="text-center mb-5">Ingresa</h2>
          <form id="do_login_user">
            <div class="form-group">
              <label for="user_email">Correo electrónico</label>
              <input type="email" class="form-control rounded shadow" id="user_email" name="user_email">
            </div>
            <div class="form-group">
              <label for="user_password">Contraseña</label>
              <input type="password" class="form-control rounded shadow" id="user_password" name="user_password">
            </div>
            <div class="form-group">
              <button class="btn btn-outline-success rounded shadow">Ingresar ahora</button>
            </div>
